...
class BattleSystems {
    ...
    static async read() {
        ...
        Utils.readJSONSystemList({ list: Utils.defaultValue(json.elements, []),
            listIDs: this.elements, listIndexes: this.elementsOrder, indexesIDs: true, cons: System.Element });
        // Statistics
        this.statistics = [];
        ...
        Utils.readJSONSystemList({ list: Utils.defaultValue(json.battleCommands, []), listIDs: this.battleCommands, listIndexes: this
